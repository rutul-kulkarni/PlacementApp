...
import com.example.rcpittnp.NewQuizModule.StudentSetsActivity;
import com.example.rcpittnp.R;

import java.util.List;
import java.util.Random;

public class StudentCatGridAdapter extends BaseAdapter {
    private List<StudentCategoryModel> catList;

    public StudentCatGridAdapter(List<StudentCategoryModel> catList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StudentQuizMainActivity.selected_cat_index = position;
                Intent intent = new Intent(parent.getContext(), StudentSetsActivity.class);
