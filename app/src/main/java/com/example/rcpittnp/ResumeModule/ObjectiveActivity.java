    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.b1:
                ...
                if(c.moveToFirst()) {
                    db.execSQL("UPDATE PersonalDet7 SET Obj ='"+ myObj.toString()+"' WHERE Name ='"+ PersonalInfoActivity.Username.getText().toString() +"'");
                    Toast.makeText(ObjectiveActivity.this, "Data saved sucessfully!", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(ObjectiveActivity.this, "Data not saved!", Toast.LENGTH_LONG).show();
                }
                break;
