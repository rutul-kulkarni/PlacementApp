    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insertInt.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(c.moveToFirst()) {
                    db.execSQL("UPDATE PersonalDet7 SET Interests ='"+ int1.getText()+" , "+int2.getText() +"' WHERE Name ='"+PersonalInfoActivity.Username.getText().toString()+"'");
                    Toast.makeText(InterestsActivity.this, "Data saved sucessfully!", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(InterestsActivity.this, "Data not saved!", Toast.LENGTH_LONG).show();
                }
