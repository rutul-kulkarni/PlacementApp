...
public class TechnicalSkillsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(TechnicalSkillsActivity.this,"Selected skill added succesfully!",Toast.LENGTH_SHORT).show();
                count++;
                insertSkills();
            }
        });
    ...
    public void insertSkills() {
        ...
        if(count == 4) {
            ...
            if(c.moveToFirst()) {
                db.execSQL("UPDATE PersonalDet7 SET TechSkills ='"+ techSkills +"' WHERE Name ='"+PersonalInfoActivity.Username.getText().toString()+"'");
                Toast.makeText(TechnicalSkillsActivity.this, "Your skill set is saved successfully!", Toast.LENGTH_LONG).show();
            }
            else
            {
                Toast.makeText(TechnicalSkillsActivity.this, "You can add only 4 skills! Please try again incase you want to change your skill set!", Toast.LENGTH_LONG).show();
            }
        }
        else {
            Toast.makeText(TechnicalSkillsActivity.this, "Selected skill added succesfully!", Toast.LENGTH_LONG).show();
        }
