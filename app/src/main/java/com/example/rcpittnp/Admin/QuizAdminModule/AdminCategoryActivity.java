...
import com.example.rcpittnp.Admin.QuizAdminModule.Adapter.AdminCategoryAdapter;
...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    public static List<AdminCategoryModel> catList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(AdminCategoryActivity.this);
        loadingDialog.setContentView(R.layout.loading_progressbar);
        loadingDialog.setCancelable(false);
        loadingDialog.getWindow().setBackgroundDrawableResource(R.drawable.progress_background);
        loadingDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);

        addCatDialog = new Dialog(AdminCategoryActivity.this);
        ...
        firestore.collection("QUIZ").document("Categories")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    if(doc.exists())
                    {
                        ...
                        for(int i=1; i <= count; i++)
                        {
                            ...
                            catList.add(new AdminCategoryModel(catid,catName,"0","1"));
                        }

                        adapter = new AdminCategoryAdapter(catList);
                        cat_recycler_view.setAdapter(adapter);

                    }
                    else
                    {
                        Toast.makeText(AdminCategoryActivity.this,"No Category Document Exists!",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                ...
                else
                {
                    ...
                    Toast.makeText(AdminCategoryActivity.this,task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                }
                        ...
                        firestore.collection("QUIZ").document("Categories")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(AdminCategoryActivity.this,"Category added successfully",Toast.LENGTH_SHORT).show();

                                        catList.add(new AdminCategoryModel(doc_id,title,"0","1"));
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(AdminCategoryActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                                        loadingDialog.dismiss();
                                    }
                                });
