...
import com.example.rcpittnp.Admin.QuizAdminModule.Adapter.AdminSetAdapter;
...
public class AdminSetsActivity extends AppCompatActivity {

    private RecyclerView setsView;
    private Button addSetB;
    private AdminSetAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_sets);
        ...
        loadingDialog = new Dialog(AdminSetsActivity.this);
    ...
    private void loadSets()
    {
        ...
        firestore.collection("QUIZ").document(catList.get(selected_cat_index).getId())
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                adapter = new AdminSetAdapter(setsIDs);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminSetsActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        loadingDialog.dismiss();
                    }
                });
                        ...
                        firestore.collection("QUIZ").document(curr_cat_id)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(AdminSetsActivity.this, " Set Added Successfully",Toast.LENGTH_SHORT).show();
