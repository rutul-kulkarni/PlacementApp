package com.example.rcpittnp.Admin.QuizAdminModule;
...
public class AdminQuestionDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(AdminQuestionDetailsActivity.this);
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        firestore.collection("QUIZ").document(catList.get(selected_cat_index).getId())
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(AdminQuestionDetailsActivity.this, " Question Added Successfully", Toast.LENGTH_SHORT).show();

                                        quesList.add(new AdminQuestionModel(
                                                doc_id,
                                                qStr,aStr,bStr,cStr,dStr, Integer.valueOf(ansStr)
                                        ));

                                        loadingDialog.dismiss();
                                        AdminQuestionDetailsActivity.this.finish();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(AdminQuestionDetailsActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                                        loadingDialog.dismiss();
                                    }
                                });
        ...
        firestore.collection("QUIZ").document(catList.get(selected_cat_index).getId())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(AdminQuestionDetailsActivity.this,"Question updated successfully",Toast.LENGTH_SHORT).show();
