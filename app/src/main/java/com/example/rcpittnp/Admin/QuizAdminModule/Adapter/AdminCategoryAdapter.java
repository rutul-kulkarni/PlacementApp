...
import com.example.rcpittnp.Admin.QuizAdminModule.Model.AdminCategoryModel;
...
public class AdminCategoryAdapter extends RecyclerView.Adapter<AdminCategoryAdapter.ViewHolder> {
    private List<AdminCategoryModel> cat_list;

    public AdminCategoryAdapter(List<AdminCategoryModel> cat_list) {
        this.cat_list = cat_list;
    }

    @NonNull
    @Override
    public AdminCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdminCategoryAdapter.ViewHolder viewHolder, int pos) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(String title, final int pos, final AdminCategoryAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AdminCategoryActivity.selected_cat_index = pos;
                    Intent intent = new Intent(itemView.getContext(), AdminSetsActivity.class);
        ...
        private void deleteCategory(final int id, final Context context, final AdminCategoryAdapter adapter)
        {
            loadingDialog.show();
            ...
            firestore.collection("QUIZ").document("Categories")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            AdminCategoryActivity.catList.remove(id);
        ...
        private void updateCategory(final String catNewName, final int pos, final Context context, final AdminCategoryAdapter adapter)
        {
            editDialog.dismiss();
                            ...
                            firestore.collection("QUIZ").document("Categories")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            AdminCategoryActivity.catList.get(pos).setName(catNewName);
                                            adapter.notifyDataSetChanged();
